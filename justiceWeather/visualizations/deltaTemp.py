...
# find the min and max deltaTemp in the dataframe
min_deltaTemp = df["deltaTemp"].min()
max_deltaTemp = df["deltaTemp"].max()
# print it out
print(f"min_deltaTemp = {min_deltaTemp}")
print(f"max_deltaTemp = {max_deltaTemp}")

# find the mean deltaTemp in the dataframe
mean_deltaTemp = df["deltaTemp"].mean()
# print it out
print(f"mean_deltaTemp = {mean_deltaTemp}")

# find the median deltaTemp in the dataframe
median_deltaTemp = df["deltaTemp"].median()
# print it out
print(f"median_deltaTemp = {median_deltaTemp}")

# find the mode deltaTemp in the dataframe
mode_deltaTemp = df["deltaTemp"].mode()
# print it out
print(f"mode_deltaTemp = {mode_deltaTemp}")

# find the standard deviation deltaTemp in the dataframe
std_deltaTemp = df["deltaTemp"].std()
# print it out
print(f"std_deltaTemp = {std_deltaTemp}")

# find the variance deltaTemp in the dataframe
var_deltaTemp = df["deltaTemp"].var()
# print it out
print(f"var_deltaTemp = {var_deltaTemp}")

# find the average deltaTemp in the dataframe removing the outliers
# find the mean deltaTemp in the dataframe
mean_deltaTemp_no_outliers = df[
    (df["deltaTemp"] > mean_deltaTemp - 2 * std_deltaTemp)
    & (df["deltaTemp"] < mean_deltaTemp + 2 * std_deltaTemp)
]["deltaTemp"].mean()
# print it out
print(f"mean_deltaTemp_no_outliers = {mean_deltaTemp_no_outliers}")
