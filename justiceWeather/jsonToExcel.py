...
# split the df into 6 different dfs, one for each year
...
df_2016.to_excel("2016_weather.xlsx", index=False)
df_2017.to_excel("2017_weather.xlsx", index=False)
df_2018.to_excel("2018_weather.xlsx", index=False)
df_2019.to_excel("2019_weather.xlsx", index=False)
df_2020.to_excel("2020_weather.xlsx", index=False)
df_2021.to_excel("2021_weather.xlsx", index=False)
